...
# region: orgs
	...
	# region: org2
		...
		export TC_ORG2_D2_WORKER=${TC_SWARM_MANAGER1[node]}
		...
		export TC_ORG2_D3_WORKER=${TC_SWARM_MANAGER1[node]}
	...
	# region: org3
		...
		export TC_ORG3_D2_WORKER=${TC_SWARM_MANAGER1[node]}
		...
		export TC_ORG3_D3_WORKER=${TC_SWARM_MANAGER1[node]}
